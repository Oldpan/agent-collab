...
const CORE_URL = "ws://10.104.9.253:3100";
        ...
        <>
          ...
          <div className="space-y-1">
            <label className="text-[10px] text-zinc-500">
              Optional env vars (shown in command)
            </label>
            <p className="text-[10px] leading-relaxed text-zinc-500">
              Usually you only need `NODE_HOSTNAME` and `CORE_URL`. `NODE_ID` and `DB_PATH`
              will be auto-generated by `agent-node`, and API keys do not need to be set here
              unless that machine requires extra env vars.
            </p>
